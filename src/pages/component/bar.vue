			...
			<view class="cu-bar tabbar bg-white">
				<view class="action">
					<view class="cuIcon-cu-image">
						<image src="/static/img/colorui/tabbar/basics_cur.png"></image>
					</view>
					<view class="text-green">元素</view>
				</view>
				<view class="action">
					<view class="cuIcon-cu-image">
						<image src="/static/img/colorui/tabbar/component.png"></image>
					</view>
					<view class="text-gray">组件</view>
				</view>
				<view class="action">
					<view class="cuIcon-cu-image">
						<image src="/static/img/colorui/tabbar/plugin.png"></image>
				...
				<view class="action">
					<view class="cuIcon-cu-image">
						<image src="/static/img/colorui/tabbar/about.png"></image>
